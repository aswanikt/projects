...
//                       label: 'UW',
//                       labelStyle:
//                           GaugeTextStyle(fontSize: 12, color: Colors.black)),
//                   GaugeRange(
//                       startValue: 18.5,
//                       endValue: 25,
//                       color: Colors.green,
...
class _BMICalculatorUIState extends State<BMICalculatorUI> {
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      buildStepperField("Age", _age, (value) => setState(() => _age = value)),
                      SizedBox(width: 10),
                      buildStepperField("Weight (kg)", _weight, (value) => setState(() => _weight = value)),
                    ],
                  ),
                  SizedBox(height: 12),
                  GestureDetector(
  ...
  Widget buildStepperField(String label, int value, Function(int) onChanged) {
    return Expanded(
      child: Container(
        height: 110,
        padding: EdgeInsets.all(12),
...
class AboutBMIPage extends StatelessWidget {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            infoTile(context, "Underweight", "< 18.5", Colors.orange),
            infoTile(context, "Normal weight", "18.5 – 24.9", Colors.green),
            infoTile(context, "Overweight", "25 – 29.9", Colors.yellow),
            infoTile(context, "Obesity", "30 and above", Colors.red),
          ],
        ),
      ),
    );
  ...
  Widget infoTile(BuildContext context, String label, String range, Color color) {
    return Card(
      elevation: 3,
      ...
      child: ListTile(
        ...
        trailing: Text(range, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
      ),
    );
  }
}